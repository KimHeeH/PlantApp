...
const PlantRegister2 = ({ navigation, route }) => {
  ...
  const InsertData = () => {
    if (PlantDate === "") {
      ...
      axios
        .post(`${SERVER_ADDRESS}/userplantdb/insert`, {
          Id: user.id,
      ...
      <View style={styles.TopBtnContainer}>
        <View style={styles.BackBtnContainer}>
          ...
          >
            ...
            <AppText
              bold
              style={{ fontSize: 18, marginLeft: 5, color: "#757575" }}
            >
              뒤로
            </AppText>
          </TouchableOpacity>
        ...
        <View style={styles.CancelBtnContainer}>
          ...
          >
            <AppText bold style={{ fontSize: 18, color: "#757575" }}>
              취소
            </AppText>
          </TouchableOpacity>
        </View>
        ...
        <KeyboardAvoidingView>
          ...
          <View style={styles.UserPlantInfoStyle}>
            <View style={styles.InfoStyle}>
              <AppText bold style={styles.infoText} allowFontScaling={false}>
                키우기 시작한 날
              </AppText>
              <TouchableOpacity
          ...
          <View style={styles.CompleteContainer}>
            <TouchableOpacity style={styles.CompleteBtn} onPress={InsertData}>
              <AppText bold style={{ fontSize: 15 }}>
                완료
              </AppText>
            </TouchableOpacity>
